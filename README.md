...
<table>
  <tr>
    <td align="center" width="25%"><img src="docs/preview/01-novel.png" alt="导入小说"  /><br/><sub><b>1. 导入小说</b></sub></td>
    <td align="center" width="25%"><img src="docs/preview/02-events.png" alt="抽取事件"  /><br/><sub><b>2. 抽取事件</b></sub></td>
    <td align="center" width="25%"><img src="docs/preview/03-skeleton.png" alt="故事骨架" /><br/><sub><b>3. 故事骨架</b></sub></td>
    <td align="center" width="25%"><img src="docs/preview/04-episodes.png" alt="分集决策" /><br/><sub><b>4. 分集决策</b></sub></td>
  </tr>
  <tr>
    <td align="center" width="25%"><img src="docs/preview/05-script.png" alt="剧本扩写"   /><br/><sub><b>5. 剧本扩写</b></sub></td>
    <td align="center" width="25%"><img src="docs/preview/06-assets.png" alt="资产生图"   /><br/><sub><b>6. 资产生图</b></sub></td>
    <td align="center" width="25%"><img src="docs/preview/07-storyboard.png" alt="分镜拆解" /><br/><sub><b>7. 分镜拆解</b></sub></td>
    <td align="center" width="25%"><img src="docs/preview/08-settings.png" alt="模型配置"  /><br/><sub><b>8. 模型配置</b></sub></td>
  </tr>
</table>
...
NovelCut 是**独立项目**,但站在两个开源项目的肩膀上:

### [open-design](https://github.com/nexu-io/open-design) (Apache 2.0)

> 灵感来源 + 直接使用了它的 web/daemon 基础设施

- ✅ 用了:Next.js + Express 工程骨架 / Skill 协议结构 / 设计系统 Markdown 格式 / 部分 UI tokens
- ❌ 没用:它的设计稿生成业务 (我们换成短剧管线)

### [Toonflow](https://github.com/HBAI-Ltd/Toonflow-app) (Apache 2.0 + 商业附加条款)

> 业务流参考 + 视觉规范对照,**未复制任何代码**

- ✅ 学了:三层 Agent 概念 / 项目级 videoRatio+imageQuality / 16:9 资产参考图 / 角色四视图视觉手册 / 智能识别资产 / 章节事件图谱思路
- ❌ 没用:它的实际代码 (NovelCut 是从 LLM 提示词到 React 组件全部重写)

License 兼容性:NovelCut 是纯 Apache 2.0,没有 Toonflow 的商业附加条款。

---

## 🤝 贡献

目前是 pre-alpha,API 频繁变动。欢迎 issue,代码贡献等稳定后再开放。

如果你正在做类似的 AI 短剧管线,欢迎交流:**xuankai110@users.noreply.github.com**
